  ...
  return (
    <div className="flex flex-col pt-32">
      ...
      <div className="grid grid-cols-1 laptop:grid-cols-3 justify-around items-center px-10 gap-4">
        <div onClick={() => router.push("/smart-home-automation/convenience#smartLighting")} className="opacity-40 bg-default rounded-xl hidden laptop:flex flex-col items-center h-80 extraSmall:h-96  justify-center relative">
        ...
        <div onClick={() => router.push("/smart-home-automation/convenience#climateControl")} className="opacity-40 bg-default  rounded-xl h-80 extraSmall:h-96 hidden laptop:flex flex-col items-center justify-center relative">
          {/* <div className="w-8 h-8 rounded-lg bg-white absolute top-4 left-4">
        {tick3?<h1 className="text-xl text-default font-[aftika-bold] pl-2 pt-0">✓</h1>:''}
          ...
          <Lottie
            ...
            className="z-10 middle:w-28 w-32"
          />
          <h1 className="testum1 text-xl w-10/12 text-center  uppercase font-[aftika-bold] text-white tracking-widest">
            Air Conditioner
          </h1>
        ...
        <div onClick={() => router.push("/smart-home-automation/convenience#heater")} className="opacity-40 bg-default rounded-xl h-80 extraSmall:h-96 hidden laptop:flex flex-col items-center justify-center relative">
          {/* <div className="w-8 h-8 rounded-lg bg-white absolute top-4 left-4">
        ...
        <div onClick={() => router.push("/efficiency")} className="opacity-40 bg-default rounded-xl h-80 extraSmall:h-96 hidden laptop:flex flex-col items-center justify-center relative">
          {/* <div className="w-8 h-8 rounded-lg bg-white absolute top-4 left-4">
