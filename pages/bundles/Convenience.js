...
function Convenience({ active, setActive }) {
  ...
  return (
    <div className="flex flex-col pt-32">
      <div className="tablet:px-10 px-8 mb-12">
        ...
        <h2 className="text-xl tracking-wide leading-none -mt-6 font-[aftika-bold]">Convenience</h2>
      </div>
      <div className="grid grid-cols-1 laptop:grid-cols-3 justify-around items-center px-10 gap-4">
        ...
        <div onClick={() => router.push("/smart-home-automation/security#protection")} className="opacity-40 bg-default hidden rounded-xl h-80 extraSmall:h-96 laptop:flex flex-col items-center justify-center relative">
          {/* <div className="w-8 h-8 rounded-lg bg-white absolute top-4 left-4">
        ...
        <div onClick={() => router.push("/smart-home-automation/security#monitor")} className="opacity-40 bg-default rounded-xl h-80 extraSmall:h-96 hidden flex flex-col items-center justify-center relative">
          {/* <div className="w-8 h-8 rounded-lg bg-white absolute top-4 left-4">
