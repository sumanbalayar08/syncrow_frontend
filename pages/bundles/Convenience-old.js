  ...
  return (
    <div className="flex flex-col pt-32">
      ...
      <div className="grid grid-cols-1 laptop:grid-cols-3 justify-around items-center px-10 gap-4">
        ...
        <div className="bg-default hidden opacity-40 rounded-xl h-80 extraSmall:h-96 laptop:flex flex-col items-center justify-center relative">
          {/* <div className="w-8 h-8 rounded-lg bg-white absolute top-4 left-4">
        ...
        <div className="opacity-40 bg-default rounded-xl h-80 extraSmall:h-96 hidden flex flex-col items-center justify-center relative">
          {/* <div className="w-8 h-8 rounded-lg bg-white absolute top-4 left-4">
