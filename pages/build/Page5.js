    ...
    <div className="flex flex-col pt-44">
      <div className="grid grid-cols-1 laptop:grid-cols-3 justify-around items-center px-10 gap-4">
        <div className="bg-default rounded-xl  flex flex-col items-center h-80 extraSmall:h-96  justify-center relative">
          ...
          <div onClick={() => router.push("/smart-home-automation/convenience#smartLighting")} className="">
          <Lottie
        ...
        <div className="bg-default rounded-xl h-80 extraSmall:h-96 flex flex-col items-center justify-center relative">
          ...
          <div onClick={() => router.push("/smart-home-automation/accessibility#multimedia")} className="">
          <Lottie
        ...
        <div className="bg-default rounded-xl h-80 extraSmall:h-96 flex flex-col items-center justify-center relative">
          ...
          <div onClick={() => router.push("/smart-home-automation/convenience#climateControl")} className="">
          <Lottie
        ...
        <div className="bg-default rounded-xl h-80 extraSmall:h-96 flex flex-col items-center justify-center relative">
          ...
          <div onClick={() => router.push("/smart-home-automation/security#protection")} className="">
          <Lottie
        ...
        <div className="bg-default rounded-xl h-80 extraSmall:h-96 flex flex-col items-center justify-center relative">
          ...
          <div onClick={() => router.push("/smart-home-automation/convenience#homeConvenience")} className="">
          <Lottie
        ...
        <div className="bg-default rounded-xl h-80 extraSmall:h-96 flex flex-col items-center justify-center relative">
          ...
          <div onClick={() => router.push("/smart-home-automation/accessibility#homeAccessibility")} className="">
          <Lottie
        ...
        <div className="bg-default rounded-xl h-80 extraSmall:h-96 flex flex-col items-center justify-center relative">
          ...
          <div onClick={() => router.push("/smart-home-automation/security#doorLock")} className="">
          <Lottie
        ...
        <div className="bg-default rounded-xl h-80 extraSmall:h-96 flex flex-col items-center justify-center relative">
          ...
          <div onClick={() => router.push("/smart-home-automation/convenience#heater")} className="">
          <Lottie
        ...
        <div className="bg-default rounded-xl h-80 extraSmall:h-96 flex flex-col items-center justify-center relative">
          ...
          <div onClick={() => router.push("/smart-home-automation/security#monitor")} className="">
          <Lottie
        ...
        <div className="bg-default rounded-xl h-80 extraSmall:h-96 flex flex-col items-center justify-center relative">
          ...
          <div onClick={() => router.push("/efficiency")} className="">
          <Lottie
